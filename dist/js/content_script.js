    ...
    return (react_1.default.createElement("div", null,
        react_1.default.createElement(antd_1.Form, { onFinish: savePrompt, 
            ...
            react_1.default.createElement(antd_1.Form.Item, { name: "userPrompt", label: "Prompt", extra: react_1.default.createElement(react_1.default.Fragment, null,
                    ...
                    `${'{sentence}'}: Sentence containing the selected text`), rules: [{ required: true, message: 'Please input your prompt' }] },
...
function DropdownMenuItem(props) {
    ...
    return (react_1.default.createElement(DropdownMenu.Item, { style: {
        ...
        isHovered && react_1.default.createElement("button", { onClick: handleEditPrompt },
...
function Images(props) {
    ...
    (0, react_1.useEffect)(() => {
        ...
        console.log((_a = inputElement.current) === null || _a === void 0 ? void 0 : _a.input);
        (_b = inputElement.current) === null || _b === void 0 ? void 0 : _b.focus();
    }, [changeImage]);
...
function Nav(props) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(antd_1.ConfigProvider, { theme: {
            ...
            react_1.default.createElement("div", { id: "ScouterNav", ref: navElement, style: {
                    cursor: 'move',
                    position: 'absolute',
                    width: '100%', top: 0,
                    background: 'white',
                ...
                react_1.default.createElement("div", { style: { zIndex: 9 } },
                    react_1.default.createElement(DropdownMenu.Root, { open: isOpenPromptMenu, onOpenChange: onMenuOpenChange },
                        ...
                        react_1.default.createElement(DropdownMenu.Portal, { container: navElement.current },
                            react_1.default.createElement(DropdownMenu.Content, { className: "DropdownMenuContent", align: 'start', sideOffset: 5, style: {
                                ...
                                react_1.default.createElement(DropdownMenu.Item, { className: "DropdownMenuItem", style: {
                                        padding: '6px',
                                        marginBottom: '4px',
                                        borderRadius: '2px'
                                    }, onSelect: () => handleMenuItemClick(defaultPrompt) }, "Default"),
                ...
                react_1.default.createElement("div", { className: "rightBtnBox", style: {
                    ...
                    props.addToAnkiStatus.status == 'success' ? react_1.default.createElement("span", null,
                        ...
                        react_1.default.createElement("a", { style: {
                            ...
                            }, href: "javascript:void(0);", onClick: editNoteInAnki.bind(event, props.addToAnkiStatus.noteId) }, "Anki")) :
...
function PopupCard(props) {
    const [messages, setMessages] = (0, react_1.useState)([{ 'content': '', 'role': 'user', 'loading': false, 'chatId': '', 'prompt': '' }]);
    const [images, setImages] = (0, react_1.useState)([]);
    ...
    (0, react_1.useEffect)(() => {
        ...
        if (props.runPrompt) {
            // 获取最近一次执行的 Prompt
            webextension_polyfill_1.default.storage.local.get({ "lastExecutedPrompt": undefined }).then((item) => {
    ...
    const executivePrompt = (prompt, runPrompt, imageToRerender) => {
                ...
                for (let i = 0; i < item.history.length; i++) {
                    ...
                    if (obj.keyWord === keyWord && obj.sentence === Sentence && obj.prompt === newPrompt[0]['content']) {
                        ...
                        setMessages(prevMessages => {
                            ...
                            const updatedLastMessage = Object.assign(Object.assign({}, lastMessage), { chatId: Date.now().toString(), role: obj.role, content: obj.answer, prompt: newPrompt[0]['content'], loading: false });
        ...
        port.onMessage.addListener(msg => {
            ...
            After that, you need to set the correct Open API Key in the Scouter:';
                    ...
                    setMessages(prevMessages => {
                        ...
                        const updatedLastMessage = Object.assign(Object.assign({}, lastMessage), { chatId: msg.chatId, content: msg.content, loading: false, prompt: prompt[0]['content'] });
                ...
                if (msg.status === 'process') {
                    try {
                        setMessages(prevMessages => {
                            ...
                            const newMsgList = lastMessage;
                            const updatedLastMessage = Object.assign(Object.assign({}, lastMessage), { chatId: msg.chatId, content: newMsgList.content + msg.content, loading: false, prompt: prompt[0]['content'] });
                            // const newMsgList = [...prevMessages.slice(0, prevMessages.length - 1), lastMessage]
                            return [...prevMessages.slice(0, prevMessages.length - 1), updatedLastMessage];
                        });
                    }
            ...
            react_1.default.createElement(antd_1.ConfigProvider, { theme: {
                            ...
                            messages.map((item) => {
                                return react_1.default.createElement("div", { key: item.chatId, className: 'p-4', style: item.role === 'user' ? { backgroundColor: '#F5F5F5' } : {} },
                                    react_1.default.createElement(antd_1.Skeleton, { loading: item.loading, active: true, title: false },
                                        react_1.default.createElement(react_markdown_1.default, { remarkPlugins: [remark_breaks_1.default], skipHtml: false, children: item.content.replace(new RegExp(props.data.keyWord, 'gi'), `**${props.data.keyWord}**`) })));
                            }),
                ...
                react_1.default.createElement("div", null,
                    react_1.default.createElement(antd_1.Drawer, { title: customPromptFormData.id === '' ? "Create Prompt" : "Edit Prompt", placement: "bottom", closable: false, height: '100%', 
                        ...
                        react_1.default.createElement(CustomPromptForm_1.CustomPromptForm, { openCustomPromptForm: openCustomPromptForm, initializePromptList: initializePromptList, data: customPromptFormData })))))));
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getUnsplashImages = exports.windowInitialization = exports.getClipboard = void 0;
const webextension_polyfill_1 = __importDefault(__webpack_require__(/*! webextension-polyfill */ "./node_modules/webextension-polyfill/dist/browser-polyfill.js"));
const getClipboard = () => {
...
const windowInitialization = (data) => {
    ...
    // 添加滚动事件，让消息列表自动滚动到底部
    (_a = data.messagesList.current) === null || _a === void 0 ? void 0 : _a.addEventListener("scroll", handleScroll);
    return () => {
        var _a;
        // console.log('useEffect return');
        (_a = data.messagesList.current) === null || _a === void 0 ? void 0 : _a.removeEventListener("scroll", handleScroll);
    };
    function handleScroll() {
        var _a;
        if (data.messagesList.current !== null) {
            const isAtBottom = ((_a = data.messagesList.current) === null || _a === void 0 ? void 0 : _a.scrollTop) + data.messagesList.current.clientHeight >= data.messagesList.current.scrollHeight - 0.5;
            if (isAtBottom) {
                // 已经位于底部，不需要自动滚动
                console.log('isAtBottom');
                return;
...
webextension_polyfill_1.default.runtime.onMessage.addListener(function (msg, sender, sendResponse) {
    ...
    if (msg.type === 'open-souter') {
        ...
        if (selection !== null) {
            ...
            // 选中文字所在的段落
            let sentence = (_c = (_b = selection.anchorNode) === null || _b === void 0 ? void 0 : _b.textContent) !== null && _c !== void 0 ? _c : '';
            if (sentence === undefined) {
                sentence = '';
            }
            else {
                sentence = sentence.length <= keyWord.length ? (_g = (_f = (_e = (_d = selection.anchorNode) === null || _d === void 0 ? void 0 : _d.parentNode) === null || _e === void 0 ? void 0 : _e.parentNode) === null || _f === void 0 ? void 0 : _f.innerText) !== null && _g !== void 0 ? _g : '' : sentence;
            }
            // 显示窗口
