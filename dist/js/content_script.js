        ...
        showMenu &&
            react_1.default.createElement("div", { style: {
                ...
                react_1.default.createElement("div", { style: {
                    ...
                    react_1.default.createElement(Checkbox, { lable: "\u5F00\u542F\u5B57\u5E55", checked: isShowCaptions, handleCheckBoxChange: showCaptions })))));
}
...
function Caption() {
    ...
    const CaptionP = ({ children }) => {
        return react_1.default.createElement("p", { className: 'captionP', onMouseEnter: () => {
    ...
    return (react_1.default.createElement("div", { style: {
        ...
        captionText.map((item, index) => react_1.default.createElement(CaptionP, { key: index }, item)) // 添加 key 避免 React 的 key warning
        :
            react_1.default.createElement(react_1.default.Fragment, null, captionText.map((item, index) => (react_1.default.createElement(CaptionP, { key: index }, item.split(' ').map((word, wordIndex) => (react_1.default.createElement("span", { className: 'captionWord', key: wordIndex, onClick: () => handleCaptionClick(word, item) }, word)))))))));
}
