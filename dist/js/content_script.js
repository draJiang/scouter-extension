...
function MessagesList(props) {
    ...
    return (react_1.default.createElement("div", { className: 'messages', style: {
        ...
        return react_1.default.createElement(Message, { message: item });
    })));
}
