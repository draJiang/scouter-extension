    ...
    return (react_1.default.createElement("div", { className: "images p-4", style: {
        ...
        react_1.default.createElement("div", null, images.length === 0 ? '' : react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement("div", { onMouseEnter: handleImagesBoxHover, onMouseLeave: handleImagesBoxHover },
                react_1.default.createElement(antd_1.Image, { "data-downloadLocation": images[imageIndex].links.download_location, src: images[imageIndex].urls.small, alt: images[imageIndex]['description'], height: 250, width: '100%', preview: false, placeholder: true }),
                showControl ?
            ...
            react_1.default.createElement("div", { style: {
                ...
                "By ",
                react_1.default.createElement("a", { style: { textDecoration: 'underline' }, target: '_blank', href: images[imageIndex].user.links.html }, images[imageIndex].user.name),
                "  on Unsplash")))));
}
...
function PopupCard(props) {
            ...
            for (let i = 0; i < item.history.length; i++) {
                ...
                if (obj.keyWord === keyWord && obj.sentence === sentence) {
                    ...
                    setMessages(prevMessages => {
                        ...
                        const updatedLastMessage = Object.assign(Object.assign({}, lastMessage), { role: obj.role, content: obj.answer, loading: false });
            ...
            if (msg.type === 'sendGPTData') {
                ...
                if (msg.status === 'erro') {
                    ...
                    setMessages(prevMessages => {
                        ...
                        const updatedLastMessage = Object.assign(Object.assign({}, lastMessage), { content: msg.content, loading: false });
    ...
    const handleSaveToAnkiBtnClick = () => {
        ...
        if (windowElement.current) {
            ...
            console.log((_b = windowElement.current.getElementsByClassName('images')[0].getElementsByTagName('img')[0].parentElement) === null || _b === void 0 ? void 0 : _b.getAttribute('data-downloadLocation'));
        }
    ...
    return (react_1.default.createElement("div", { id: "LearningEnglish2023", ref: windowElement, style: {
        ...
        react_1.default.createElement(antd_1.ConfigProvider, { theme: {
            ...
            react_1.default.createElement("div", { className: 'flex-grow flex flex-col overflow-scroll' },
                react_1.default.createElement("div", { className: 'flex-grow overflow-scroll', ref: messagesList, style: { paddingTop: '44px' } },
                    ...
                    react_1.default.createElement("div", { className: 'messages', style: {
                        ...
                        messages.map((item) => {
                            return react_1.default.createElement("div", { className: 'p-4', style: item.role === 'user' ? { backgroundColor: '#F5F5F5' } : {} },
                        ...
                        react_1.default.createElement("div", { className: 'p-4' }, isApiErro ? react_1.default.createElement("img", { src: settingGuide_png_1.default, style: {
                                borderRadius: '4px'
                            } }) : '')))),
