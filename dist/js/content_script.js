        ...
        if (needToRunPrompt) {
          ...
          `
            ...
            Sentence: ${keyWord}`
                ...
                // 处理 Prompt 中的变量
                let p = yield (0, util_1.handlePromptVariables)(prompt.userPrompt, keyWord, Sentence);
                ...
                if (msg.status === 'process') {
                    try {
                        setMessages(prevMessages => {
                            ...
                            const updatedLastMessage = Object.assign(Object.assign({}, lastMessage), { chatId: msg.chatId, content: newContent, loading: false, prompt: prompt[0]['content'] });
                            // const newMsgList = [...prevMessages.slice(0, prevMessages.length - 1), lastMessage]
                            return [...prevMessages.slice(0, prevMessages.length - 1), updatedLastMessage];
                        });
                    }
                            ...
                            messages.map((item) => {
                                return react_1.default.createElement("div", { key: item.chatId, className: '', style: item.role === 'user' ? { backgroundColor: '#F6F6F6', paddingTop: '2px', paddingBottom: '2px' } : {} },
                                    react_1.default.createElement(antd_1.Skeleton, { loading: item.loading, active: true, title: false },
                                        react_1.default.createElement(react_markdown_1.default, { remarkPlugins: [remark_breaks_1.default], rehypePlugins: [rehype_raw_1.default], skipHtml: false, children: item.content })));
                            }),
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.handleHightlight = exports.getAnkiCards = exports.handlePromptVariables = exports.getUnsplashImages = exports.windowInitialization = exports.getClipboard = void 0;
const webextension_polyfill_1 = __importDefault(__webpack_require__(/*! webextension-polyfill */ "./node_modules/webextension-polyfill/dist/browser-polyfill.js"));
const getClipboard = () => {
 ...
 * @throws {异常类型} 异常描述
 */
const handlePromptVariables = (promptStr, keyWord, Sentence) => __awaiter(void 0, void 0, void 0, function* () {
...
function handleHightlightClick(event) {
    alert('hello');
    console.log(event);
}
