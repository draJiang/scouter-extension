...
function CustomPromptForm(props) {
    ...
    return (react_1.default.createElement("div", null,
        react_1.default.createElement(antd_1.Form, { onFinish: savePrompt, 
            ...
            react_1.default.createElement(antd_1.Form.Item, { name: "getUnsplashImages", label: "Images", valuePropName: "checked" },
            ...
            react_1.default.createElement(antd_1.Form.Item, { name: "userPrompt", label: "Prompt", extra: react_1.default.createElement(react_1.default.Fragment, null,
                ...
                react_1.default.createElement(antd_1.Input.TextArea, { placeholder: "Translate {selection} to Chinese", onKeyDown: handleKeyDown, rows: 4 })),
            react_1.default.createElement(antd_1.Form.Item, { style: { margin: '0' } },
                ...
                react_1.default.createElement(antd_1.Button, { style: { minWidth: '100px' }, type: "primary", htmlType: "submit" }, "Save")))));
}
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(antd_1.ConfigProvider, { theme: {
            ...
            react_1.default.createElement("div", { id: "ScouterNav", ref: navElement, style: {
                ...
                react_1.default.createElement("div", { style: { zIndex: 9999 } },
                    react_1.default.createElement(DropdownMenu.Root, { open: isOpenPromptMenu, onOpenChange: onMenuOpenChange },
                        react_1.default.createElement(DropdownMenu.Trigger, { asChild: true },
                            react_1.default.createElement("button", { className: "IconButton", "aria-label": "Customise options", style: {
                                ...
                                react_1.default.createElement("span", { style: { marginRight: '4px' } }, props.lastExecutedPrompt.title),
                        ...
                        react_1.default.createElement(DropdownMenu.Portal, { container: navElement.current },
                            react_1.default.createElement(DropdownMenu.Content, { className: "DropdownMenuContent", sideOffset: 5, style: {
                                    backgroundColor: '#fff',
                                    cursor: 'default',
                                    display: 'flex',
                                    flexDirection: 'column',
            ...
            react_1.default.createElement(antd_1.ConfigProvider, { theme: {
                ...
                react_1.default.createElement("div", { className: 'w-full', ref: inputRef, style: { borderTop: '1px solid rgba(5, 5, 5, .06)' } },
                    react_1.default.createElement(antd_1.Form, { form: form, onFinish: handleSendMessage, 
                        ...
                        react_1.default.createElement(antd_1.Form.Item, { style: { margin: '0' } }))),
                react_1.default.createElement("div", null,
                    react_1.default.createElement(antd_1.Drawer, { title: "Create Prompt", placement: "bottom", closable: false, height: 440, 
                        // onClose={onClose}
                        open: isPopoverOpen, getContainer: false, extra: react_1.default.createElement(antd_1.Space, null,
                            react_1.default.createElement(antd_1.Button, { onClick: () => openCustomPromptForm({ isOpen: false, data: { 'title': '', 'getUnsplashImages': false, 'userPrompt': '', 'id': '' } }) }, "Cancel")) },
