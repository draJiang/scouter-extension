...
function Selection(props) {
    ...
    const speaker = () => {
        ...
        try {
            ...
            (0, util_1.textToSpeechDownload)(props.text, lang_1.languageCodes[targetLanguage]);
