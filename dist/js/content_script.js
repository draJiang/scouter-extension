    ...
    return (react_1.default.createElement("div", null,
        react_1.default.createElement(antd_1.Form, { onFinish: savePrompt, 
            ...
            react_1.default.createElement(antd_1.Form.Item, { name: "title", label: "Title", rules: [{ required: true, message: 'Please input your title' }] },
                react_1.default.createElement(antd_1.Input, { maxLength: 12, onKeyDown: handleKeyDown, placeholder: "How to name the Prompt", type: "text" })),
...
function Images(props) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { className: "images", ref: imageBoxElement, style: {
                position: 'relative',
                lineHeight: '0',
                marginTop: '18px'
            } }, showImages ?
                                    ...
                                    react_1.default.createElement("div", null,
                                        react_1.default.createElement("div", { style: {
                                            ...
                                            react_1.default.createElement("div", { style: {
                                                ...
                                                react_1.default.createElement(antd_1.Button, { type: "text", size: "small", style: { color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center' }, onClick: () => setShowImages(false), icon: react_1.default.createElement(icons_1.EyeInvisibleOutlined, null) }),
        ...
        react_1.default.createElement(antd_1.ConfigProvider, { theme: {
            ...
            react_1.default.createElement("div", { id: "ScouterNav", ref: navElement, className: 'p-4', style: {
                ...
                react_1.default.createElement("div", { className: "rightBtnBox", style: {
                    ...
                    react_1.default.createElement(antd_1.Button, { size: 'small', disabled: addToAnkiStatus.status === 'standby' || addToAnkiStatus.status === 'loading' ? true : false, style: {
                            fontSize: '13.2px'
...
let USER_INFO = { userId: 'unknow', verified: false, contextMenu: false, showYoutubeButton: true };
...
function Caption() {
    ...
    const handleMouseMove = (event) => {
        ...
        if (dragging && captionElement.current) {
            ...
            let videoY = (video === null || video === void 0 ? void 0 : video.offsetTop) || ((_b = document.querySelector('#full-bleed-container')) === null || _b === void 0 ? void 0 : _b.offsetTop);
            if (isFullscreen) {
    ...
    return (react_1.default.createElement("div", { onMouseDown: handleMouseDown, onMouseUp: handleMouseUp, onMouseMove: handleMouseMove, ref: captionElement, style: {
            position: 'absolute',
            bottom: '60px',
            zIndex: '50',
            cursor: 'move'
        ...
        captionText.map((item, index) => (react_1.default.createElement(CaptionLine_1.CaptionLine, { key: index, fontSize: fontSize }, item.split(' ').map((word, wordIndex) => (react_1.default.createElement("span", { className: 'captionWord', key: wordIndex, onClick: () => handleCaptionClick(word, item) }, word.trim())))))),
        showButton &&
            react_1.default.createElement("button", { style: Object.assign(Object.assign({}, buttonStyle), { right: '0', bottom: '8px' }), onClick: handleOpenWindow },
