...
function initialize() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        setYoutubeButton();
        // 获取 Anki 信息
        ANKI_INFO = yield (0, util_2.setAnkiInfo)();
    });
}
/////////////////////////////////////////////////////////////////////////////////////
// 初始化用户信息
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.setAnkiInfo = exports.thisGetUserInfo = void 0;
const webextension_polyfill_1 = __importDefault(__webpack_require__(/*! webextension-polyfill */ "./node_modules/webextension-polyfill/dist/browser-polyfill.js"));
const util_1 = __webpack_require__(/*! ./PopupCard/util */ "./src/contentScript/PopupCard/util.ts");
...
// 获取 Anki 信息
const setAnkiInfo = () => __awaiter(void 0, void 0, void 0, function* () {
    let ANKI_INFO = { defaultDeckName: '', decks: [], models: [] };
    // 获取 Anki decks
...
exports.setAnkiInfo = setAnkiInfo;
...
function Caption() {
    ...
    return (react_1.default.createElement("div", { 
        ...
        showButton &&
            react_1.default.createElement("button", { style: Object.assign(Object.assign({}, buttonStyle), { cursor: 'move', width: '30px', height: '40px' }), onMouseDown: handleMouseDown, onMouseUp: handleMouseUp, onMouseMove: handleMouseMove },
        ...
        showButton &&
            react_1.default.createElement("button", { style: Object.assign(Object.assign({}, buttonStyle), { right: '0' }), onClick: handleOpenWindow },
