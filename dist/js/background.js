    ...
    webextension_polyfill_1.default.runtime.onConnect.addListener(port => {
        ...
        port.onMessage.addListener(msg => {
            ...
            if (msg.type === 'getGPTMsg') {
                ...
                isContinue = true;
                // 获取存储的 API Key  
                webextension_polyfill_1.default.storage.sync.get(["openApiKey"]).then((result) => {
