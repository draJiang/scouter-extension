...
function Message(props: MessageProps) {
  ...
  useEffect(() => {
    ...
    setMessageIndex(
      props.message.content.length <= 0 ? 0 : props.message.content.length - 1
    );
  ...
  return (
    ...
    >
      <Skeleton
        style={{ margin: "18px 0" }}
        loading={
          props.message.content[props.message.content.length - 1]["status"] ===
          "begin"
            ? true
            : false
        }
      ...
      >
                ...
                .then((response) => {
                  ...
                  if (response.succeeded) {
                    ...
                    if ("message" in response.data) {
                      ...
                      alert(
                        "The current AI endpoint does not support image generation."
                      );
                    }
                  }
                });
        ...
        >
            ...
            >
              ...
              >
                ...
                <div style={{ margin: "0 2px" }}>
                  {messageIndex + 1 + "/" + props.message.content.length}
                </div>
                <IconButton
                  type="text"
                  size="small"
          ...
          <div>
            ...
            {/* API 错误的引导图 */}
            {content["status"] === "invalid_api_key" && (
              <div className="">
                <img
                  src={settingGuideImage}
                  style={{
                    borderRadius: "4px",
                  }}
                />
