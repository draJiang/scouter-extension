            ...
            <div className="flex flex-col p-6 mx-4 min-w-72 max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow  xl:p-8 ">
              ...
              <ul role="list" className="mb-8 space-y-4 text-left">
                ...
                <li className="flex items-center space-x-3">
                  ...
                  <span>Summarize Webpage Content</span>
                </li>
                <li className="flex items-center space-x-3">
                  {/* <!-- Icon --> */}
                  <svg
                ...
                <li className="flex items-center space-x-3">
                  ...
                  <span>Paste the image from the clipboard</span>
                </li>
                <li className="flex items-center space-x-3">
                  {/* <!-- Icon --> */}
                  <svg
            ...
            <div className="flex flex-col p-6 mx-4 min-w-72 max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow  xl:p-8 ">
              ...
              <ul role="list" className="mb-8 space-y-4 text-left">
                ...
                <li className="flex items-center space-x-3">
                  ...
                  <a
                    target="_blank"
                    href="https://jiangzilong.notion.site/Learning-in-YouTube-YouTube-1d61fd50815a42a5af394db4a695c712?pvs=4"
                  >
                    <svg
                      width="15"
                      height="15"
                ...
                <li className="flex items-center space-x-3">
                  ...
                  <a
                    target="_blank"
                    href="https://jiangzilong.notion.site/Search-images-396d245dece948ff803b9e51f56bb38f?pvs=4"
                  >
                    <svg
                      width="15"
                      height="15"
                ...
                <li className="flex items-center space-x-3">
                  ...
                  <a
                    target="_blank"
                    href="https://jiangzilong.notion.site/Paste-the-image-from-the-clipboard-3606ca8e574f4652ac5837203c651da7?pvs=4"
                  >
                    <svg
                      width="15"
                      height="15"
                ...
                <li className="flex items-center space-x-3">
                  ...
                  <a
                    target="_blank"
                    href="https://jiangzilong.notion.site/Follow-up-question-c321072e9cbc4bcfb51843647aa72045?pvs=4"
                  >
                    <svg
                      width="15"
                      height="15"
                ...
                <li className="flex items-center space-x-3">
                  ...
                  <a
                    target="_blank"
                    href="https://jiangzilong.notion.site/Content-Editable-Pro-54644438b77d4d3fb756cf8baaf5357a?pvs=4"
                  >
                    <svg
                      width="15"
                      height="15"
              ...
              <a
                ...
                onClick={() => {
                  window.open(
                    "https://jiang.lemonsqueezy.com/checkout/buy/e31f8c18-7bf2-4f6b-85c2-508fb500ce84"
                  );
                }}
                className="text-white hover:text-white bg-orange-400 hover:bg-orange-500 focus:ring-4 focus:ring-primary-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center "
              >
                Get started
              </a>
              <>
                <a
                  href="#"
                  onClick={showModal}
                  className=" mt-2 hover:text-orange-500 text-orange-400  focus:ring-4 focus:ring-primary-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center "
                >
                  微信支付
                </a>
                <Modal
                  ...
                  <div className="flex flex-col justify-center items-center gap-3">
                    ...
                    <p>
                      ...
                      <a
                        ...
                        href="mailto:jzlong666@gmail.com?subject=请发送 Scouter 激活码"
                      >
                        jzlong666@gmail.com
                      </a>
                    </p>
